...
if __name__ == "__main__":
    ...
    # UI FIX: Added proxy_headers and forwarded_allow_ips to ensure Uvicorn uses HTTPS for assets behind Hugging Face's reverse proxy.
    uvicorn.run(gradio_asgi, host="0.0.0.0", port=7860, proxy_headers=True, forwarded_allow_ips="*")