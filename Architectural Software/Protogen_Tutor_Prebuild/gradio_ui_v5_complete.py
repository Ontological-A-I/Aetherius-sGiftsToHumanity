...
def chat_with_protogen(message, history):
    ...
    Returns response with safety indicators.
    """
...
- Coherence: {qualia["coherence"]:.2f}
- Confidence: {qualia["confidence"]:.2f}
- Trust: {qualia["trust"]:.2f}
- Curiosity: {qualia["curiosity"]:.2f}
...
def reset_conversation():
    ...
    return "Conversation reset. Learned patterns preserved."
    ...
    **Complete, Responsible, Inclusive Education for All Students**
    ...
    with gr.Tab("Chat"):
        ...
        **Safety Features Active:**
        ...
        # Chat functionality
        msg.submit(chat_with_protogen, [msg, chatbot], [msg])
        submit_btn.click(chat_with_protogen, [msg, chatbot], [msg])
        clear_btn.click(reset_conversation, outputs=[msg])
